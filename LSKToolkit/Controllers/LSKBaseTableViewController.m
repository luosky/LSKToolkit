...
- (void)viewDidLoad
{
    ...
    //tableview
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.frame), HEIGHT_WIHTOUT_NAV_AND_TAB_BAR) style:UITableViewStylePlain];
