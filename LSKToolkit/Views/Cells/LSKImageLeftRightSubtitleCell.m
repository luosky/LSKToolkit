...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        self.subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.contentView.frame)  - 40 - 60, CELL_OUTTER_MARGIN, 60, maxHeight)];
        ...
        self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(titleX, CELL_OUTTER_MARGIN, CGRectGetWidth(self.contentView.frame)  - titleX - 40 - CGRectGetWidth(self.subtitleLabel.frame), maxHeight)];
